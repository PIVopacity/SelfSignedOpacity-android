...
package exponent.selfsignedcred.opacity;
...
//	Original commands, modified below for self-signed example
...
//	public static final String SELECT_PIV = SELECT + ' ' + PIV_LENGTH + ' ' + PIV + " 00";
	...
	public static final String PIV = "A0 00 00 03 08 00 00 10 00 99";
	public static final String PIV_LENGTH = "0A";
	public static final String SELECT_PIV = SELECT + ' ' + PIV_LENGTH + ' ' + PIV + " 00";
