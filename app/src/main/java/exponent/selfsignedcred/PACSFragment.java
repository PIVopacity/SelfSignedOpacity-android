...
package exponent.selfsignedcred;
...
import exponent.selfsignedcred.credentialservice.SelfSignedCredService;
...
public class PACSFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        SelfSignedCredService.logger = new Logger(MainActivity.mainActivity, pacsLogText);
        ...
        clearbutton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                SelfSignedCredService.logger.clear();
            }
        });
        ...
        if(SelfSignedCredService.opacityTag.equals("2E"))
        {
        ...
        opacResetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0)
            {
                MainActivity.mainActivity.stopService(new Intent(MainActivity.mainActivity,SelfSignedCredService.class));
                ...
                MainActivity.mainActivity.startService(new Intent(MainActivity.mainActivity,SelfSignedCredService.class));
            }
        });
